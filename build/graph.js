...
Graph = {
  ...
  setMessage: function(message, type) {
    ...
    alerts = $("#alerts");
    return alerts.append("<div class=\"alert alert-" + type + "\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" + message + "</div>");
  },
  ...
  login: function() {
    return FB.login((function(response) {
      ...
      if (response.authResponse) {
        ...
        return console.error("failed to login to facebook");
      }
    }), this.getPermissions());
  },
  run: function(fn) {
